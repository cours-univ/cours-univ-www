...
autocompleteButton = document.getElementById("autocomplete");
...
tabulation = document.getElementById("tabulation");
...
input.onkeydown = function(e){
    ...
    if(autocompleteOn && !deleteAutocomplete(this, actualKey, nextChar, previousChar)){
    ...
    else if(!writeTabulation(this, actualKey, e, shiftKey, selection)){
...
window.onload = function(){
    ...
    if(localStorage.getItem("autocomplete") == "on"){
        autocompleteButton = document.getElementById("autocomplete");
